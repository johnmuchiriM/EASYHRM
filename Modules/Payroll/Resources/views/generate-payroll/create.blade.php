...
@section('title', __('payroll::lang.create-payroll'))
@section('content')
<div class="app-main__inner">
    ...
    <form action="{{route('payroll.store')}}" method="post" class="needs-validation" novalidate>
        @csrf
        @include('payroll::generate-payroll.create-partial.employee')
        @include('payroll::generate-payroll.create-partial.employee-earning')
        @include('payroll::generate-payroll.create-partial.employee-deduction')
    </form>
</div>
@endsection
