        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="email"  value="{{ old('email') }}" class="form-control  @error('email') is-invalid @enderror" required name="email">
                            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>{{ __('employees::employee.password') }}</label><span class="text-danger"> *</span>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <label>{{ __('employees::employee.confirm-password') }}</label><span class="text-danger"> *</span>
